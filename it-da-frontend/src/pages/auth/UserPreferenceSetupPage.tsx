...
const questions = [
    {
        ...
        subtitle: "나의 에너지 유형",
        options: [
            { value: "EXTROVERT", emoji: "🎉", title: "외향적", desc: "많은 사람과\n활발하게 교류" },
            { value: "INTROVERT", emoji: "☕", title: "내향적", desc: "소수와\n깊은 대화" },
        ],
        key: "energyType",
    },
    {
        ...
        subtitle: "관계 vs 활동",
        options: [
            { value: "RELATIONSHIP", emoji: "👫", title: "관계 중심", desc: "새로운 사람들과\n친해지는 게 목적" },
            { value: "TASK", emoji: "🎯", title: "활동 중심", desc: "함께 무언가를\n하는 게 목적" },
        ],
        key: "purposeType",
    },
    {
        ...
        subtitle: "정기 vs 즉흥",
        options: [
            { value: "REGULAR", emoji: "📅", title: "정기적", desc: "일정한 시간에\n꾸준히 참여" },
            { value: "SPONTANEOUS", emoji: "✨", title: "즉흥적", desc: "그때그때\n기분따라" },
        ],
        key: "frequencyType",
    },
    {
        ...
        subtitle: "실내 vs 실외",
        options: [
            { value: "INDOOR", emoji: "🏠", title: "실내", desc: "카페, 스터디룸\n편안한 공간" },
            { value: "OUTDOOR", emoji: "🌳", title: "실외", desc: "공원, 운동장\n야외 활동" },
        ],
        key: "locationType",
    },
    {
        ...
        subtitle: "가성비 vs 퀄리티",
        options: [
            { value: "VALUE", emoji: "💰", title: "가성비", desc: "합리적인 가격의\n알찬 모임" },
            { value: "QUALITY", emoji: "💎", title: "퀄리티", desc: "비용보다\n경험이 중요" },
        ],
        key: "budgetType",
    },
    {
        ...
        subtitle: "주도 vs 참여",
        options: [
            { value: "LEADER", emoji: "👑", title: "주도형", desc: "모임을 이끄는 것을 좋아해요" },
            { value: "FOLLOWER", emoji: "🙋", title: "참여형", desc: "편하게 참여하는 것을 선호해요" },
        ],
        key: "leadershipType",
    },
    {
        ...
        options: [
            ...
            { value: "FLEXIBLE", emoji: "⏰", title: "유연", desc: "시간 상관없어요" },
        ],
    },
    {
        id: 8,
        ...
        <div className="signup-container">
            <div className="signup-modal">
                <div className="modal-header">
                    ...
                    <p className="header-subtitle">맞춤 추천을 위해 몇 가지만 여쭤볼게요!</p>
                </div>
                        ...
                        <div className="options-container">
                            {currentQ.options?.map((option) => (
                                <button
                                    ...
                                    onClick={() => handleOptionClick(currentQ.key as string, option.value)}
                                >
                ...
                {currentQ.isTimePreference && (
                    <div className="step-content">
                        ...
                        <button className="submit-btn" onClick={() => setCurrentQuestion(currentQuestion + 1)}>다음</button>
                    </div>
                )}
                ...
                {currentQ.isInterest && (
                    <div className="step-content">
                        ...
                        <button className="submit-btn" onClick={handleFinalSubmit} disabled={isLoading || interests.length < 3}>
                ...
                {currentQuestion > 0 && (
                    <button className="back-btn" style={{ marginTop: "1rem" }} onClick={() => setCurrentQuestion(currentQuestion - 1)}>
                        ← 이전으로
                    </button>
                )}
            </div>
