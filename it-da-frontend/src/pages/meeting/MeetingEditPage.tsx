...
import "./MeetingCreatePage.css"; // 같은 스타일 사용
...
const MeetingEditPage = () => {
  ...
  const fetchMeetingData = async () => {
    try {
      ...
      console.log("✅ 기존 모임 데이터:", meeting);

      // 주최자 체크
      if (meeting.organizerId !== user?.userId) {
        alert("모임 주최자만 수정할 수 있습니다.");
      ...
      console.error("❌ 모임 데이터 로딩 실패:", err);
