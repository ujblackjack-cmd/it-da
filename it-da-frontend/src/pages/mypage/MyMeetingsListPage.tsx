        ...
        {loading ? (
          ...
          <>
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                ...
                                if (meeting.chatRoomId) {
                                  ...
                                  // ✅ 데이터가 비어있을 때의 피드백
                                  console.error(
                                    "❌ chatRoomId가 없습니다. 백엔드 응답을 확인하세요.",
                                  );
                                  toast.error(
            ...
            <section className="mml-section">
              <div className="mml-section-header">
                <h2>✅ 완료된 모임</h2>
                <span className="mml-count completed">
                  {completedMeetings.length}개
                </span>
              </div>
                      ...
                      <div className="mml-card-content">
                        ...
                        <div className="mml-rating">
                          <span className="mml-stars">
                            ...
                            {"☆".repeat(
                              5 - Math.floor(meeting.averageRating || 0),
                            )}
                          </span>
