...
const MyMeetingsPage: React.FC<Props> = ({ upcoming, completed, onOpenChat, onOpenReview }) => {
    return (
                        ...
                        return (
                            <div key={m.meetingId} className="meeting-card">
                                <div className="meeting-image">
                                    <div className="meeting-status status-upcoming">{dday ?? m.statusText}</div>
                                </div>
            ...
            {completed.length === 0 ? (
                ...
                <div className="meeting-grid">
                    {completed.map((m) => (
                        <div key={m.meetingId} className="meeting-card">
                            <div className="meeting-image">
                                <div className="meeting-status status-completed">{m.statusText || '완료'}</div>
                            </div>
                            ...
                            <div className="meeting-content">
                                ...
                                <div className="meeting-footer">
                                    <div className="meeting-rating">⭐ {Number(m.averageRating || 0).toFixed(1)}</div>
                                    <button
                                        className="meeting-btn"
                                        type="button"
