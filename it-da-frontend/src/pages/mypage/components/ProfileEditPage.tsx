...
const ProfileEditPage: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // ✅ 스토어 업데이트 (기존 user 정보 유지하면서 업데이트)
            const updatedUser = {
                ...user!,
            ...
            alert("프로필이 수정되었습니다!");
            navigate("/mypage");  // ✅ /my-meetings → /mypage로 변경!
        } catch (e) {
            ...
            <div className="profile-form">
                ...
                <div className="form-row">
                    ...
                    <div className="gender-selector">
                        <button
                            className={`gender-btn ${profileData.gender === "M" ? "active" : ""}`}
                            onClick={() => handleChange("gender", "M")}
                        >
                            남
                        </button>
                        <button
                            className={`gender-btn ${profileData.gender === "F" ? "active" : ""}`}
                            ...
                            {!selectedRegion
                                ...
                                : DISTRICTS[selectedRegion]?.map((d) => (
                                    <div
                                        key={d}
                                        className="region-item"
                                        onClick={() => handleRegionSelect(selectedRegion, d)}
                                    >
                                        {d}
                                    </div>
                                ))}
                    ...
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="mbti-grid">
                            {MBTI_TYPES.map((m) => (
                                <button
                                    key={m}
                                    className={`mbti-btn ${profileData.mbti === m ? "active" : ""}`}
                                    onClick={() => {
                                        handleChange("mbti", m);
